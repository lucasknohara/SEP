        ...
        <main>
            ...
            <section className="features-section">
                ...
                <div className="features-grid">
                    <FeatureCard icon="📷" title="Captura Inteligente" description="Melhore suas fotos de estudo automaticamente." details="A proposta permite analisar e melhorar a qualidade das fotos de estudo, garantindo que cada imagem seja clara e útil para o aprendizado." />
                    <FeatureCard icon="🧠" title="IA para estudos" description="Transforme suas capturas em conteúdo útil." details="A proposta utiliza inteligência artificial para transformar suas capturas em resumos, FlashCards, anotações e materiais de estudo organizados." />
